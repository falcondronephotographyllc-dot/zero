...
CREATE TABLE IF NOT EXISTS workers (
  ...
  status TEXT NOT NULL,
  last_heartbeat TEXT,
  ohlcv_exists INTEGER NOT NULL DEFAULT 0,
  bbo_exists INTEGER NOT NULL DEFAULT 0,
  ohlcv_size_bytes INTEGER NOT NULL DEFAULT 0,
  bbo_size_bytes INTEGER NOT NULL DEFAULT 0,
  ohlcv_sha256 TEXT NOT NULL DEFAULT '',
  bbo_sha256 TEXT NOT NULL DEFAULT '',
  first_timestamp TEXT NOT NULL DEFAULT '',
  last_timestamp TEXT NOT NULL DEFAULT '',
  approximate_row_count INTEGER NOT NULL DEFAULT 0
);
...
CREATE TABLE IF NOT EXISTS strategy_results (
  ...
  avg_daily_profit REAL NOT NULL DEFAULT 0,
  max_intraday_dd REAL NOT NULL DEFAULT 0,
  max_daily_loss REAL NOT NULL DEFAULT 0,
  cold_retention REAL NOT NULL DEFAULT 0,
  mffu_breach_rate REAL NOT NULL DEFAULT 0,
  trade_count INTEGER NOT NULL DEFAULT 0,
  best_session TEXT NOT NULL DEFAULT '',
